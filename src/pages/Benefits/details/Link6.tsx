    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            REACH Velora enables teams to move quickly from initial concept to fully visualized digital prototypes, significantly reducing development timelines and allowing faster decision-making before physical sampling begins.
          </p>

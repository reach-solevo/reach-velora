    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Designers can experiment with multiple shapes, materials, textures, and structures in a flexible 3D environment, encouraging innovation without the limitations of traditional workflows.
          </p>
